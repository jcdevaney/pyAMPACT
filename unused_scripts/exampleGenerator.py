from runAlignmentExampleGen import run_alignment_example_gen
def example_generator(midifile, audiofile, numNotes,stateOrd,noteNum,means,covars, width,targetsr,nharm,winms):
    ...
    # run the alignment
    [allstate,selectstate,spec,yinres,dtw]=run_alignment_example_gen(audiofile, midifile, numNotes, stateOrd, noteNum, means, covars, learnparams,width,targetsr,nharm,winms);
    return dtw
    ...
    # processors
    #nmat2midi(nmatNew,'exampleOneNotePerformance.mid')
